...
# import your helpers from the right module(s)
# adjust the import path below to match your project
from .core import (
    _filetype, is_macho, macho_info, verify_codesign, spctl_assess,
    scan_app_bundle, scan_pkg, scan_dmg
)
